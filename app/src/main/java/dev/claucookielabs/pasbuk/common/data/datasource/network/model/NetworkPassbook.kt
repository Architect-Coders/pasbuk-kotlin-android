...
data class NetworkPassbook(
    ...
    val logoText: String?,
    val boardingPass: NetworkPass?,
    val coupon: NetworkPass?,
    val eventTicket: NetworkPass?,
    val generic: NetworkPass?,
    val storeCard: NetworkPass?,
    var logoImage: String?,
    var backgroundImage: String?,
    var stripImage: String?,
